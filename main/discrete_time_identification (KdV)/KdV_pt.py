...
def train_lbfgs(model, x0_pt,x1_pt, lambda_1, lambda_2,dt, IRK_alpha,IRK_beta,u0_pt,u1_pt, num_iter=50_000):
    ...
    closure_fn = partial(closure, model, x0_pt,x1_pt, lambda_1, lambda_2,dt, IRK_alpha,IRK_beta,u0_pt,u1_pt)
    optimizer.step(closure_fn) 
    
def closure(model, x0_pt,x1_pt, lambda_1, lambda_2,dt, IRK_alpha,IRK_beta,u0_pt,u1_pt):
    optimizer.zero_grad()
    loss = mse(model, x0_pt,x1_pt, lambda_1, lambda_2,dt, IRK_alpha,IRK_beta,u0_pt,u1_pt)
    loss.backward(retain_graph=True)
    global iter
...
if __name__ == "__main__":
    ...
    train_lbfgs(model, x0_pt,x1_pt, lambda_1, lambda_2,dt, IRK_alpha,IRK_beta,u0_pt,u1_pt, num_iter=10_000)
