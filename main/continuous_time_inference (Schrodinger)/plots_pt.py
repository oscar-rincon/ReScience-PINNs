...
data = pd.read_csv('outputs/pt_training_Schrodinger.csv')
...
plt.savefig('outputs/pt_training_Schrodinger.png')
...
for i in range(100, 10_001, 100):
    ...
    with torch.no_grad():
        ...
        # Save the figure
        image_path = os.path.join(image_dir, f'model_Schrodinger_{i}.png')
