...
if __name__== "__main__":
    ...
    np.savetxt("outputs/lambda_1s_clean.csv", lambda_1s, delimiter=",", header="l1", comments="")    
    np.savetxt("outputs/lambda_2s_clean.csv", lambda_2s, delimiter=",", header="l2", comments="")    
    torch.save(model.state_dict(), f'outputs/pt_model_NS_clean.pt')
